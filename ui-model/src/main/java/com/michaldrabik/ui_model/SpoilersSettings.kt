...
data class SpoilersSettings(
  ...
  val isDroppedShowsHidden: Boolean,
  val isDroppedShowsRatingsHidden: Boolean,
  ...
  val isDroppedMoviesHidden: Boolean,
  val isDroppedMoviesRatingsHidden: Boolean,
  ...
  companion object {
    val INITIAL = SpoilersSettings(
      ...
      isDroppedShowsHidden = false,
      isDroppedShowsRatingsHidden = false,
      ...
      isDroppedMoviesHidden = false,
      isDroppedMoviesRatingsHidden = false,
