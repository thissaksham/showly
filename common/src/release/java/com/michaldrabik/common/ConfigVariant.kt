...
object ConfigVariant {
  ...
  val SHOW_STATIC_SYNC_COOLDOWN by lazy { DAYS.toMillis(7) }
  val MOVIE_SYNC_COOLDOWN by lazy { HOURS.toMillis(12) }
  val MOVIE_STATIC_SYNC_COOLDOWN by lazy { DAYS.toMillis(7) }
